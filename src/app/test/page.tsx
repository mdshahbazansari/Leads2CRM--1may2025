...
//   const contentKey = "apimag";
//   // searchParams.get('contentKey'); // Get contentKey from the URL
...
//     //       description:
//     //         "API governance ensures consistent API development, deployment, and management across the organization. Effective governance enables scalability, maitainability, and compliance.",
...
//     <div className="overflow-x-hidden pb-[90px] pt-[61px]">
...
//           <a href="#" className="hover:underline text-bold">Home</a>
//         </li>
//         <li className="mx-2">/</li>
//         <li className='text-bold'>
//           <a href="#" className="hover:underline ">{sections[0]?.sectiontitle}</a>
//         </li>
//       </ol>
//     </nav>
//   </div>
//             <h1 className="text-5xl font-extrabold text-white mb-4 mt-3">
...
//       </div>
//       {/* /second pat */}
//       {/* <div className="w-full bg-gradient-to-r from-main via-gray-50 to-main py-24"> */}
//       <div className="w-full bg-gradient-to-r from-[#3498db] via-[#ffffff] to-mai py-24">

//       <div className="container mx-auto px-8 lg:px-6">
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
//           {/* First Column */}
//           <div className="fcc-item text-left p-6 bg-white rounded-lg shadow-lg transition-transform transform hover:scale-105">
//             <div className="p-colview">
//               <h3 className="text-3xl font-bold text-black mb-4">Expedited Implementation</h3>
//               <p className="text-base text-gray-700 mb-6">
//                 A modern visualization and diagnostic analytics solution that is fast and 
//                 easy to learn. Use out-of-the-box content or create your own reports, 
//                 dashboards, and graphs in minutes.
//               </p>
//             </div>
//           </div>
...
//           <div className="fcc-item text-left p-6 bg-white rounded-lg shadow-lg transition-transform transform hover:scale-105">
//             <div className="p-colview">
//               <h3 className="text-3xl font-bold text-black mb-4">Increased Mobility</h3>
//               <p className="text-base text-gray-700 mb-6">
//                 A cloud and browser-based Business Intelligence solution that supports 
//                 business analysts and any leaders by delivering powerful reports with 
//                 drill-downs and dashboards, on any device.
//               </p>
//             </div>
//           </div>
...
//           <div className="fcc-item text-left p-6 bg-white rounded-lg shadow-lg transition-transform transform hover:scale-105">
//             <div className="p-colview">
//               <h3 className="text-3xl font-bold text-black mb-4">Valuable Insights</h3>
//               <p className="text-base text-gray-700 mb-6">
//                 Integrated with your Epicor ERP, you can have a single source of truth, 
//                 while still being flexible enough to work with user-defined fields, 
//                 custom SQL queries, and multiple data sources to help you make 
...
//       {/* First Row: Content on the left, Image on the right */}
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center mb-8">
//         {/* Content Column */}
//         <div className="col-12 col-lg-7 my-auto">
//           <div className="feat-desc--txt">
//             <h2 className="text-2xl font-bold mb-2 text-black">Financial Statements</h2>
//             <h3 className="text-xl font-semibold mb-4 text-black">Modern Reporting For Data Efficiencies</h3>
//             <p className="u-pb-30 u-mb-0 text-black mb-4">
//               Get the most out of your ERP data and preserve its integrity with EDA Financial 
//               Statements: cloud-based reporting, analysis, and visualization. Epicor specifically 
//               designed the interface for faster consolidation, seamless exporting, and user customization.
//             </p>
//             <ul className="list-disc list-inside mb-4 text-black">
//               <li className="bullet--secondary-1 p-0">Customize financial statements for managers and stakeholders</li>
//               <li className="bullet--secondary-1 p-0">Configure statement data to specific users and proactively manage KPIs</li>
//             </ul>
//             <a 
//               href="/en/products/business-intelligence-software/epicor-data-analytics/financial-statements/"
//               target="_blank" 
//               className="btn j tonal bg-mai text-white py-2 px-4 rounded"
//             >
//               LEARN MORE
//             </a>
//           </div>
...
//         <div>
//           <Image 
//             src="https://assets.epicor.com/m/147393408fc5cd6f/original/mfg-the-voice-of-ai-banner.jpg" 
//             alt="AI Solutions"
//             width={500}
//             height={300}
...
//       {/* Second Row: Image on the left, Content on the right */}
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center mb-8">
//         {/* Image Column */}
//         <div>
//           <Image 
...
//       {/* Third Row: Content on the left, Image on the right */}
...
//   {
//     title: "Modern Tech",
//     content: "Modern Tech involves cutting-edge technologies and tools that shape the future of the web development world. From AI-powered tools to next-gen frameworks, it all falls under Modern Tech."
//   },
//   {
//     title: "Agile Approach",
//     content: "The Agile Approach focuses on flexibility and continuous improvement. By using Agile methodologies, we ensure that we meet client expectations, even in an ever-changing project environment."
//   },
//   {
//     title: "Dedicated Development",
//     content: "Dedicated Development means working with a specialized team that focuses solely on a project. With this approach, you get a team that understands your goals and works diligently to make them happen."
//   },
// ];
...
//   return (
//     <div className="flex flex-col md:flex-row items-center mt-16 bg-[#1d8bf2] text-white p-8 rounded-lg">
//       <div className="md:w-1/2 p-6 flex flex-col items-start border-r-2 border-white relative">
//         {/* Dynamic Highlight in Border */}
//         <div
//           className="absolute top-0 right-0 w-2 bg-yellow transition-all duration-300"
//           style={{ height: '50px', top: `${highlightTop}px`, transform: 'translateX(60%)' }}
//         ></div>
//         {/* <h3 className="text-3xl font-poppins font-medium text-left">
//           Portfolio of HTML5 Projects
//         </h3> */}
//         <div className="relative mt-4 w-full">
//           <ul
//             ref={listRef}
//             className="space-y-3 list-none text-left pl-4"
//           >
//             {portfolioItems.map((item, index) => (
//               <li
//                 key={index}
//                 className={`cursor-pointer pl-2 ${
//                   selectedItem.title === item.title ? 'font-bold' : ''
//                 }`}
...
//         <p className="text-left">{selectedItem.content}</p>
//       </div>
//     </div>
//   );
// }
