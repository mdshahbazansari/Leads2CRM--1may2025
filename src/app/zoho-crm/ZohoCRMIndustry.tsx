...
const industries = [
    {
        ...
        desc: "Built on the award-winning Zoho CRM, the Travel Agency CRM is meant for travel agencies and tour operators to better manage their leads, clients, trips, quotes, invoices, vendors, and reservations.",
    ...
    },
    {
        ...
        desc: "Built on the award-winning Zoho CRM, the Real Estate Agency CRM is meant for brokerage firms to better manage their properties, leads, recommendations, deals, invoices, and activities.",
    ...
    },
    {
        ...
        desc: "Built on the award-winning Zoho CRM, the Real Estate Developer CRM is meant for developers to better manage their properties, clients, deals, offers, contracts, and activities.",
    ...
    },
    {
        ...
        desc: "Built on the award-winning Zoho CRM, the Training Provider CRM is meant for training institutes and individual trainers to better manage their leads, contacts, courses, enrolments, and activities.",
    ...
    {
        title: "Law Firm CRM",
        desc: "Built on the award-winning Zoho CRM, the Law Firm CRM is meant for law firms and individual lawyers to better manage their leads, contacts, matters, contracts, hourly billing, and activities.",
    ...
    },
    {
        ...
        desc: "Built on the award-winning Zoho CRM, the Entertainer CRM is meant for magicians, musicians, singers, and DJs to better manage their leads, contacts, services, shows, invoices, and activities.",
