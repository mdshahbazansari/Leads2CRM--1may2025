    ...
    return (
        <section className="bg-[#eaf2e3] rounded-2xl px-2 md:p-8 w-full max-w-7xl mx-auto my-6">
            <div className="flex flex-col md:flex-row items-stretch">
                ...
                <div className="relative flex-shrink-0 flex flex-col items-start justify-center md:w-1/4 w-full pb-8 px-6 md:pr-0 md:pl-4">
                    <h2 className="text-4xl font-extrabold mb-0 leading-tight text-[#1a2734]">
                        Explore<br />More
                    </h2>
                    {/* Subtle geometric pattern - SVG */}
                    <svg
                        className="absolute left-0 bottom-0 w-56 h-40 opacity-40 text-[#bcd6b6] pointer-events-none"
                        fill="none"
                        viewBox="0 0 224 160"
                    >
                        <defs>
                ...
                {/* Right: Cards */}
                <div className="flex-1 grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#dbead3]">
                    {/* Card 1: Careers */}
                    <div className="flex flex-col items-start px-6 py-8">
                        ...
                        <h3 className="text-xl font-bold text-[#1a2734] mb-1">Careers</h3>
                    ...
                    <div className="flex flex-col items-start px-6 py-8">
                        ...
                        <h3 className="text-xl font-bold text-[#1a2734] mb-1">Blog</h3>
                        <p className="text-[#4a5a53] text-base mb-4">
                    ...
                    <div className="flex flex-col items-start px-6 py-8">
                        ...
                        <h3 className="text-xl font-bold text-[#1a2734] mb-1">Resources</h3>
                        <p className="text-[#4a5a53] text-base mb-4">
