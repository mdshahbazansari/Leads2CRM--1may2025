...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Stay up to date with the latest features, integrations, and upcoming events! We’re rolling out new updates to improve your experience, including an enhanced user interface and new platform integrations      </p> */}
      <div>
        <input
          type="text"
          name="name"
